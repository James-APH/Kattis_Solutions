...
int getCharNum(int index, string str) { return str[index] - '0'; }

void countSym(int index, string str, double &whitespace, double &lowercase,
              double &uppercase, double &symbols) {
